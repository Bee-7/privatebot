...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    header('Location: manage_texts.php');
}
?>
            ...
            <div class="tab-content mt-2" id="pills-tabContent">
                ...
                <div class="tab-pane fade show active" role="tabpanel" tabindex="0">
                    ...
                    <div class="row gx-2 gy-0 justify-content-around">
                        ...
                        <form action="manage_texts.php" method="post">
                            <?php foreach ($texts as $key => $text) {?>
                                <div class="row">
                                    <div class="mb-3">
                                        <label for="" class="form-label">متن مربوط به : ( <?php echo $key;?> )</label>
                                        <textarea class="form-control" placeholder="متن خود را در این قسمت وارد کنید . . ." id="text-<?php echo $key;?>" name="text[<?php echo $key;?>]" rows="4"><?php echo $texts[$key];?></textarea>
                                    </div>
                                </div>
                            <?php }?>
